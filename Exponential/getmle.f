...
c                     1 if Power
c                     2 if Hill
c                     3 if exponential models 2 
c                     4 if exponential models 3 
c                     5 if exponential models 4 
c                     6 if exponential models 5 
c                                       
c     OUTPUT:
...
C
     ...
     $     XPARMS2,XLL,XOPTITE,XNRESM,XBIND,XMODEL,XFLAG,XLOGNORM)
      INCLUDE 'O8COMM.INC'
      INCLUDE 'O8FINT.INC'
      INCLUDE 'PROBLEM.INC'
      INTEGER XNDOSES,XNANIM(*),XNPARMS,XADVERSE,XMODEL,XFLAG,XLOGNORM,
