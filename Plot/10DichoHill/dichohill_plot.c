...
int main(int argc, char *argv[]) {
  ...
  if (flag1 == 1 && flag2 == 1) {
    fprintf(fp_out, "set title 'Dichotomous-Hill Model, with BMR of %lg%% %s for the BMD and %lg Lower Confidence Limit for the BMDL' \n",
  ...
  fprintf(fp_out, "plot [x=%f:%f] [%f:%f] f(x) title 'Dichotomous-Hill',\\", xleft>0?0:xleft, xright, ybottom, ytop);
